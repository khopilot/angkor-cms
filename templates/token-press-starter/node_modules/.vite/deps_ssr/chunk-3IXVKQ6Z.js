// ../../node_modules/.pnpm/modern-tar@0.7.5/node_modules/modern-tar/dist/unpacker-Dcww6JeE.js
var BLOCK_SIZE = 512;
  ...
  return {
    add(header) {
      ...
      if (currentHeader !== null) {
        const error = new Error("Previous entry must be completed before adding a new one");
        onError(error);
        throw error;
      }
      try {
    ...
    write(chunk) {
      ...
      if (newTotal > currentHeader.size) {
        const error = new Error(`"${currentHeader.name}" exceeds given size of ${currentHeader.size} bytes.`);
        onError(error);
        throw error;
      }
      try {
    ...
    finalize() {
      ...
      if (currentHeader !== null) {
        const error = new Error("Cannot finalize while an entry is still active");
        onError(error);
        throw error;
      }
      try {
...
var STATE_HEADER = 0;
var STATE_BODY = 1;
var truncateErr = new Error("Tar archive is truncated.");
...
// ../../node_modules/.pnpm/modern-tar@0.7.5/node_modules/modern-tar/dist/web/index.js
...
export {
  createGzipEncoder,
  createGzipDecoder,
  createTarPacker2 as createTarPacker,
  createTarDecoder,
  packTar,
  unpackTar
};
//# sourceMappingURL=chunk-3IXVKQ6Z.js.map
