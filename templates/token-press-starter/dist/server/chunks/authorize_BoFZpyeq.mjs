...
import { v as validateRedirectUri, b as buildDeniedRedirect, a as handleAuthorizationApproval } from "./oauth-authorization_D5Y-OqYT.mjs";
...
function csrfCookieHeader(token, request) {
