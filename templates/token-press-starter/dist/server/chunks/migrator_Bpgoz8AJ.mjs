...
import { f as freeze, W as WithSchemaPlugin, g as getLast } from "./sql_DV5B95Nm.mjs";
class NoopPlugin {
  transformQuery(args) {
    return args.node;
  }
...
const NO_MIGRATIONS = freeze({ __noMigrations__: true });
class Migrator {
  #props;
  constructor(props) {
...
export {
  ...
  DEFAULT_ALLOW_UNORDERED_MIGRATIONS as b,
  MIGRATION_LOCK_ID as c
};
